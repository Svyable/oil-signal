...
def test_verified_eia_registry_covers_core_report_and_demand_series() -> None:
    ...
    assert routes["PET.CRPRODUS.W"] == "seriesid/PET.WCRFPUS2.W"
    assert routes["PET.CREXUS.W"] == "seriesid/PET.WCREXUS2.W"
    assert routes["PET.CRINUS.W"] == "seriesid/PET.WCRRIUS2.W"
